        ...
        <div className="space-y-16 w-full">
          <div className="flex flex-col md:flex-row items-center gap-8 p-4 pt-8">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-2xl pb-2 mb-4">
                Create your Account
              </h2>
              <p className="text-gray-600 text-lg mb-4">
                Sign up for echo.vault in seconds. All you need is an email
                <br />
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 p-4">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-2xl pb-2 mb-4">
                Write Your Time Capsule
              </h2>
              <p className="text-gray-600 text-lg mb-4">
                Write a message to your future self. Share your current goals,
                thoughts, or
                <br />
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 p-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg mb-4">
                Choose when to unlock your message. It can be months or years
                from now—
                <br />
                the choice is yours.
              </p>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8 p-4">
            ...
            <div className="flex-1">
              <h2 className="font-bold text-2xl pb-2 mb-4">
                Reflect to Your Past Self
              </h2>
              <p className="text-gray-600 text-lg mb-4">
                When the time comes, our AI will analyze your message and send
                you
                <br />
                thoughtful reflections, insights about how you've grown, and
                more.
              </p>
            </div>
          </div>
